...
<script type="text/javascript">
	...
	$(function(){
		...
		showActivityList();
		//为关联市场活动模态窗口中的搜索框绑定事件，通过触发回车键，查询并展现所需市场的活动列表
