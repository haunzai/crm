...
<script type="text/javascript" src="jquery/bootstrap3-typeahead.min.js"></script>
	...
	$(function () {
		...
		//查询活动
		$("#create-activityBtn").click(function () {
		...
		//查询联系人
		$("#contact-searchBtn").click(function () {
			$("#findContacts").modal("show");
		})
		$("#searchContactByName").keydown(function (event) {
			if (event.keyCode == 13) {
				$.ajax({
					url:"workbench/transaction/searchContact.do",
					data:{
						"name":$.trim($("#searchContactByName").val())
					},
					type:"get",
					dataType:"json",
					success:function (data) {
		...
		$("#submitContactBtn").click(function () {
			var $xz=$("input[name=xz]:checked");
			var id=$xz.val();
			$("#create-contactsName").val($("#"+id).text());
			$("#create-contactsId").val(id);
			$("#findContacts").modal("hide");
		})
		//为阶段的下拉框绑定事件，根据选中的阶段填写可能性
		$("#create-stage").change(function () {
			var svalue=$("#create-stage").val();
			$("#create-possibility").val(json[svalue]);
		})
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" placeholder="请输入联系人名称，支持模糊查询" id="searchContactByName">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
	...
	<form action="workbench/transaction/save.do" id="tranFrom" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="create-activityBtn"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<div class="form-group">
			<label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" id="contact-searchBtn"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
